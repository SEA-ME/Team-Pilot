...
public:
            ...
            std::dynamic_pointer_cast< HelloWorldStub>(_stub))
    {
                ...
                HelloWorldSomeIPStubAdapterHelper::addStubDispatcher( { CommonAPI::SomeIP::method_id_t(0x7b) }, &structInMethodStubDispatcher );
...
CommonAPI::SomeIP::MethodWithReplyStubDispatcher<
    ...
    std::tuple< ::v1::commonapi::HelloWorld_::testStructDeployment_t>,
    std::tuple< CommonAPI::SomeIP::IntegerDeployment<int32_t>>
> HelloWorldSomeIPStubAdapterInternal<_Stub, _Stubs...>::structInMethodStubDispatcher(
    &HelloWorldStub::structInMethod,
    false,
