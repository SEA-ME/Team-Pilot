...
HelloWorldSomeIPProxy::HelloWorldSomeIPProxy(
        ...
        : CommonAPI::SomeIP::Proxy(_address, _connection )
    {
        ...
        void HelloWorldSomeIPProxy::structInMethod(const HelloWorld::testStruct &_structParameter, CommonAPI::CallStatus &_internalCallStatus, int32_t &_output, const CommonAPI::CallInfo *_info) {
            ...
            CommonAPI::SomeIP::ProxyHelper<
                CommonAPI::SomeIP::SerializableArguments<
                    CommonAPI::Deployable<
                        HelloWorld::testStruct,
                        ::v1::commonapi::HelloWorld_::testStructDeployment_t
                    >
                >,
                CommonAPI::SomeIP::SerializableArguments<
                    CommonAPI::Deployable<
    ...
    std::future<CommonAPI::CallStatus> HelloWorldSomeIPProxy::structInMethodAsync(const HelloWorld::testStruct &_structParameter, StructInMethodAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable< HelloWorld::testStruct, ::v1::commonapi::HelloWorld_::testStructDeployment_t> deploy_structParameter(_structParameter, static_cast< ::v1::commonapi::HelloWorld_::testStructDeployment_t* >(nullptr));
        CommonAPI::Deployable< int32_t, CommonAPI::SomeIP::IntegerDeployment<int32_t>> deploy_output(static_cast< CommonAPI::SomeIP::IntegerDeployment<int32_t>* >(nullptr));
