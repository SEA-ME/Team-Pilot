...
public:
    ...
    COMMONAPI_EXPORT virtual void structInMethod(const std::shared_ptr<CommonAPI::ClientId> _client, CAN::canStruct _structParameter, structInMethodReply_t _reply);
