...
public:
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void structInMethod(const CAN::canStruct &_structParameter, CommonAPI::CallStatus &_internalCallStatus, int32_t &_output, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     */
    virtual std::future<CommonAPI::CallStatus> structInMethodAsync(const CAN::canStruct &_structParameter, StructInMethodAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr);
...
template <typename ... _AttributeExtensions>
void CANProxy<_AttributeExtensions...>::structInMethod(const CAN::canStruct &_structParameter, CommonAPI::CallStatus &_internalCallStatus, int32_t &_output, const CommonAPI::CallInfo *_info) {
    delegate_->structInMethod(_structParameter, _internalCallStatus, _output, _info);
}

template <typename ... _AttributeExtensions>
std::future<CommonAPI::CallStatus> CANProxy<_AttributeExtensions...>::structInMethodAsync(const CAN::canStruct &_structParameter, StructInMethodAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
