...
void VsomeData::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<VsomeData *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (VsomeData::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VsomeData::qthumChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (VsomeData::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VsomeData::qttmpChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (VsomeData::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VsomeData::qtrpmChanged)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (VsomeData::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VsomeData::qtspdChanged)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (VsomeData::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VsomeData::qtbatChanged)) {
                *result = 4;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject VsomeData::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_VsomeData.data,
    qt_meta_data_VsomeData,
    qt_static_metacall,
    nullptr,
    nullptr
} };
